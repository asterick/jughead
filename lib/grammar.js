...
var grammar = {
    ...
    {"name": "statement$ebnf$1", "symbols": ["access"], "postprocess": id},
    {"name": "statement$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "statement$ebnf$2", "symbols": [{"literal":"def"}], "postprocess": id},
    {"name": "statement$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "statement$ebnf$3", "symbols": []},
    {"name": "statement$ebnf$3", "symbols": ["statement$ebnf$3", "type"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "statement", "symbols": ["statement$ebnf$1", "statement$ebnf$2", (lexer.has("identifier") ? {type: "identifier"} : identifier), {"literal":":"}, "statement$ebnf$3"]},
    ...
    {"name": "field$ebnf$1", "symbols": ["access"], "postprocess": id},
    {"name": "field$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "field$ebnf$2", "symbols": [{"literal":"def"}], "postprocess": id},
    {"name": "field$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "field$ebnf$3", "symbols": []},
    {"name": "field$ebnf$3", "symbols": ["field$ebnf$3", "type"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "field", "symbols": ["field$ebnf$1", "field$ebnf$2", (lexer.has("identifier") ? {type: "identifier"} : identifier), {"literal":":"}, "field$ebnf$3"]},
    {"name": "field$ebnf$4", "symbols": []},
    {"name": "field$ebnf$4", "symbols": ["field$ebnf$4", "field"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "field", "symbols": [{"literal":"section"}, {"literal":"["}, "expression", {"literal":"]"}, {"literal":"{"}, "field$ebnf$4", {"literal":"}"}]},
